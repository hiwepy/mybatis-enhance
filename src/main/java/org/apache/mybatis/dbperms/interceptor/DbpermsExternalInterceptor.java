...
public abstract class DbpermsExternalInterceptor extends AbstractDbpermsInterceptor {

	protected static Logger LOG = LoggerFactory.getLogger(DbpermsExternalInterceptor.class);
