...
import org.apache.mybatis.dbperms.i18n.handler.AbstractDataI18nHandler;
...
public class DefaultDataI18nHandler extends AbstractDataI18nHandler {
	...
	public Object doHandle(Locale locale,Invocation invocation, MetaResultSetHandler metaResultSetHandler, Collection<Object> orginList, Collection<Object> i18nList) throws Exception  {
		...
		try {
			...
			// 找到Dao方法上的国际化注解
			PermPrimary i18nPrimary = AnnotationUtils.findAnnotation(method, PermPrimary.class);
			PermMapper i18nMapper = AnnotationUtils.findAnnotation(method, PermMapper.class);
			// 循环原始数据
