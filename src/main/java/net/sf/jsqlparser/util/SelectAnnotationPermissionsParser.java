...
public class SelectAnnotationPermissionsParser extends StatementVisitorAdapter
	...
	private RequiresPermission[] permissions;
	
	public SelectAnnotationPermissionsParser(MetaStatementHandler metaHandler, RequiresPermission[] permissions) {
    ...
    public void visit(Table table) {
        ...
        if (ArrayUtils.isNotEmpty(permissions)) {
        	// 查找匹配的权限
        	Optional<RequiresPermission> optional = Stream.of(permissions)
