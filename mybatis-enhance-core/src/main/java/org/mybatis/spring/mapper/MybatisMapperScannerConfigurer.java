 ...
 * <pre class="code">
 * {@code
 *   <bean class="org.mybatis.spring.mapper.MybatisMapperScannerConfigurer">
 ...
 * @version $Id$
 */
public class MybatisMapperScannerConfigurer implements
	...
	public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry) {
		...
		// 使用扩展的MybatisClassPathMapperScanner对象扫描器
		ClassPathMapperScanner scanner = new MybatisClassPathMapperScanner(this.applicationContext, registry);
