...
public class SelectAnnotationPermissionParser extends SelectItemVisitorAdapter
	...
	public SelectAnnotationPermissionParser(MetaStatementHandler metaHandler, RequiresPermission permission) {
